...
def getinf(item):
    ...
    print_date = str(pytesseract.image_to_string(
        Image.open(r"img2.png"), lang='eng'))
    ...
    img1.save('img2.png')
    img1.close()
    print_number = str(pytesseract.image_to_string(
        Image.open(r"img2.png"), lang='eng'))
    ...
    img1.save('img2.png')
    img1.close()
    print_ammount = str(pytesseract.image_to_string(
        Image.open(r"img2.png"), lang='eng'))
    ...
    img1.save('img2.png')
    img1.close()
    print_buyer = str(pytesseract.image_to_string(
        Image.open(r"img2.png"), lang='eng'))
    ...
    img1.save('img2.png')
    img1.close()
    print_seller = str(pytesseract.image_to_string(
        Image.open(r"img2.png"), lang='eng'))
...
if invoice_pdf:
    ...
    rotated = rotate(image, angle, (0, 0,
                                    0))  # cancelling the skew in the original image and rorated is the new image after cancelling the skew in the original image
    ...
    if (found == 0 and flag != -1):
        ...
        if st.button("Onboard"):
            ...
            if len(ref_point) >= 2:
                ...
                db.invoices.update_one({"keyword": keyword}, {
                    "$set": {"Date": {"x1": ref_point[2][0], "y1": ref_point[2][1], "x2": ref_point[3][0],
                                      "y2": ref_point[3][1]}}})
                img3.save('img2.png')
                img3.close()
                image = Image.open('img2.png')
                ...
                db.invoices.update_one({"keyword": keyword}, {
                    "$set": {"Buyer": {"x1": ref_point[8][0], "y1": ref_point[8][1], "x2": ref_point[9][0],
                                       "y2": ref_point[9][1]}}})
                img3.save('img2.png')
                img3.close()
                image = Image.open('img2.png')
